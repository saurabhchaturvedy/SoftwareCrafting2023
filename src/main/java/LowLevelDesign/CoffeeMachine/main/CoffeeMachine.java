...
import main.java.LowLevelDesign.CoffeeMachine.beverages.BeverageFactory;
import main.java.LowLevelDesign.CoffeeMachine.beverages.IBeverage;
import main.java.LowLevelDesign.CoffeeMachine.composers.IComposer;
    ...
    public IBeverage requestBeverage(String beverageType) {
        ...
        synchronized (ingredientHolder) {
            ...
            for (Map.Entry<String, Integer> ingredientQuantity : composition.entrySet()) {
                ...
                if (ingredientHolder.getIngredientQuantity(ingredientQuantity.getKey()) < ingredientQuantity.getValue()) {
