package main.java.LowLevelDesign.CoffeeMachine.main;
...
import main.java.LowLevelDesign.CoffeeMachine.composers.*;
import main.java.LowLevelDesign.CoffeeMachine.constants.BeverageConstants;
import main.java.LowLevelDesign.CoffeeMachine.constants.IngredientsConstants;
import main.java.LowLevelDesign.CoffeeMachine.ingredients.IngredientHolder;
...
public class DemoApplication {
    public static void main(String args[]) {
        ...
        CoffeeMachine coffeeMachine = CoffeeMachine.Builder.getNewInstance().setBrandName("ChaiPoint").setNoOfSlots(count_n).setIngredientHolder(new IngredientHolder(total_items_quantity)).setComposers(composerMap).build();
